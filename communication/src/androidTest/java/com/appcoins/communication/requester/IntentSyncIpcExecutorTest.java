...
public class IntentSyncIpcExecutorTest {
    ...
    public void setup() {
        ...
        service = new IntentSyncIpcMessageSender(messageSender, messageResponseSynchronizer, idGenerator, TIMEOUT);
    }

    @Test
    public void sendMessageTest() throws InterruptedException, MainThreadException {
