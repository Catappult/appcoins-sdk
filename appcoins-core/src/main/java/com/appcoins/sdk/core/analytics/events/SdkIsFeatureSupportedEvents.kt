...
enum class SdkIsFeatureSupportedProperties(
    ...
    FEATURE_FROM_FEATURE_SUPPORTED_REQUEST(FEATURE, SDK_IS_FEATURE_SUPPORTED_REQUEST, 1000, true),

    RESULT_FROM_FEATURE_SUPPORTED_RESULT(RESULT, SDK_IS_FEATURE_SUPPORTED_RESULT, 1010, true),
}
