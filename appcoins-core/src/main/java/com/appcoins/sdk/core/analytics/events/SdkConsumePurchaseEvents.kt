...
enum class SdkConsumePurchaseProperties(
    ...
    RESPONSE_CODE_FROM_CONSUME_PURCHASE_RESULT(RESPONSE_CODE, SDK_CONSUME_PURCHASE_RESULT, 400),

    PURCHASE_TOKEN_FROM_CONSUME_PURCHASE_REQUEST(PURCHASE_TOKEN, SDK_CONSUME_PURCHASE_REQUEST, 410),
    PURCHASE_TOKEN_FROM_CONSUME_PURCHASE_RESULT(PURCHASE_TOKEN, SDK_CONSUME_PURCHASE_RESULT, 411),
}
