...
public class AnalyticsManagerProvider {
    ...
    private static List<String> provideIndicativeEventList() {
        ...
        list.add(SdkInstallWalletDialogEvents.SDK_WALLET_INSTALL_DIALOG);
        list.add(SdkInstallWalletDialogEvents.SDK_WALLET_INSTALL_DIALOG_ACTION);
        list.add(SdkInstallWalletDialogEvents.SDK_WALLET_INSTALL_DIALOG_VANILLA_IMPRESSION);
        list.add(SdkInstallWalletDialogEvents.SDK_WALLET_INSTALL_DIALOG_FALLBACK_IMPRESSION);
        list.add(SdkInstallWalletDialogEvents.SDK_WALLET_INSTALL_DIALOG_SUCCESS);
