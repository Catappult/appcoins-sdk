...
enum class SdkGeneralFailureProperties(
    ...
    SIGNED_DATA_FROM_SIGNATURE_VERIFICATION_FAILURE(SIGNED_DATA, SDK_PURCHASE_SIGNATURE_VERIFICATION_FAILURE, 100),

    API_KEY_FROM_SIGNATURE_VERIFICATION_FAILURE(API_KEY, SDK_PURCHASE_SIGNATURE_VERIFICATION_FAILURE, 510),

    TYPE_FROM_UNEXPECTED_FAILURE(TYPE, SDK_UNEXPECTED_FAILURE, 520),

    DATA_FROM_UNEXPECTED_FAILURE(DATA, SDK_UNEXPECTED_FAILURE, 530),
}
