...
enum class SdkQuerySkuDetailsProperties(
    ...
    SKUS_FROM_SKU_DETAILS_REQUEST(SKUS, SDK_QUERY_SKU_DETAILS_REQUEST, 1500),
    SKUS_FROM_SKU_DETAILS_RESULT(SKUS, SDK_QUERY_SKU_DETAILS_RESULT, 1501),
    SKUS_FROM_SKU_DETAILS_FAILURE_PARSING_SKUS(SKUS, SDK_QUERY_SKU_DETAILS_FAILURE_PARSING_SKUS, 1502),

    SKU_TYPE_FROM_SKU_DETAILS_REQUEST(SKU_TYPE, SDK_QUERY_SKU_DETAILS_REQUEST, 1510),
    SKU_TYPE_FROM_SKU_DETAILS_FAILURE_PARSING_SKUS(SKU_TYPE, SDK_QUERY_SKU_DETAILS_FAILURE_PARSING_SKUS, 1511),
}
