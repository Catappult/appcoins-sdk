...
public class PayloadHelperTest {
    ...
    @Test public void buildIntentPayloadWithEmptyDeveloperPayload() {
    ...
    @Test public void buildIntentPayloadWithNullDeveloperPayload() {
        String intentPayload = PayloadHelper.buildIntentPayload(null, null, null);
        Assert.assertEquals("appcoins://appcoins.io", intentPayload);
    }

    @Test public void buildIntentPayloadSuccess() {
